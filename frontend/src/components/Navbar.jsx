...
import logo1 from "..//assets/png-clipart-youtube-play-button-computer-icons-youtube-youtube-logo-angle-rectangle-thumbnail.png";
      ...
      <div className="relative">
        <nav className="fixed w-full bg-white z-10 bg-theme">
          <div className="w-[90%] xl:w-[95%] mx-auto flex justify-between items-center gap-2 sm:gap-10 lg:gap-36 py-6 h-20 bg-theme">
            <Link
              to="/"
              className="text-white flex items-center justify-center gap-2 bg-theme lg:gap-4"
            >
              <img
                className="w-8 h-8 lg:w-10 lg:h-10 object-contain"
                src={logo1}
              />
              <span className="text-base sm:text-2xl lg:text-3xl font-bold tracking-tighter text-theme  lg:tracking-[-3px]">
                YouTube
              </span>
            </Link>
            <div className="flex justify-center items-center">
              <form
                ...
                className="w-[140px] relative xsm:w-[150px] sm:w-[200px] md:w-[300px] lg:w-[400px] xl:w-[500px] 3xl:w-[700px]"
              >
                <input
                  {...register("search", { required: true })}
                  className="font-[450] placeholder:text-lg ring-1 ring-black ring-opacity-20 dark:ring-white dark:ring-opacity-30 py-1 sm:py-2 lg:py-2 rounded-3xl w-[100%] px-3 text-sm lg:text-xl bg-theme"
                  type="text"
                  placeholder="Search"
                />
              ...
              {isLogged ? (
                <>
                  <Link
                    ...
                    className={`rounded-full size-9 flex justify-center ring-1 items-center ring-opacity-20 overflow-hidden ${
                      mode !== "dark" ? "ring-primary-black" : "ring-white"
                    }`}
                  >
                    <img
                ...
                >
                  ...
                  <span className="text-xs sm:text-sm lg:text-md hidden xsm:block">
                    Sign In
                  </span>
                </Link>
              )}
